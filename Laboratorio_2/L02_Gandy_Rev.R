...
# Agregar estos guiones para marcarlo como subtitulo y ouede ser = o -
# -------------------------------
...
#### En este caso no era necesario establecer una semilla pero ese es su funcionamiento,
#### para que cuando lo ejecutes nuevamente, te arroje los mismos resultados
